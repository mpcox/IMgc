...
# the current strategy is to remove (a minimal # of) individuals that drive
# 4-gamete violations and infinite sites violations.
#
# August Woerner
# University of Arizona
# Currently UNT Health Science Center
# august.woerner@unthsc.edu
#
# Contributions by Murray Cox
#
# bioperl requirement removed
# 15 june 2011
#
# confirmed runs on perl v5.18.2
# 31 december 2018

# Copyright (C) 2007 Murray P. Cox and August E. Woerner
